...
WindowsAPI.setWindowBorderColor(50, 20, 25);

var options:Array = ['storyMode', 'options'];
...
bg.screenCenter('x');
bg.color = FlxColor.fromRGB(80, 30, 35);

var magentaBg:FlxSprite = new FlxSprite().loadGraphic(Paths.image('ui/menuBG'));
add(magentaBg);
...
magentaBg.color = FlxColor.fromRGB(100, 50, 55);
